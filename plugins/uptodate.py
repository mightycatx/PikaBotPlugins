...
OFFICIAL_UPSTREAM_REPO = "https://gitHub.com/ItzSjDude/PikachuUserBot"
BOT_IS_UP_TO_DATE = "ItzSjDude userbot is up-to-date!."
NEW_BOT_UP_DATE_FOUND = (
    "**ItzSjDude Update Found For** {branch_name}\n"
    "\n\n{changelog}\n"
    "Pulling Updates !!"
)
NEW_UP_DATE_FOUND = (
...
async def deploy_start(bot, message, refspec, remote):
    ...
    await message.edit(
        "My Sweet Master! I am updating kindly wait for a min or two 🤗 after that Do {x}ping or {x}alive  ...my sweet master !!!".format(
            x=rx
        )
    )
